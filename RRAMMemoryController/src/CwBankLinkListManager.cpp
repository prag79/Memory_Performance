...
* @return void
**/
void CwBankLinkListManager::getTail(const uint8_t& chanNum, const uint16_t& codeWordNum, int32_t& value)
{
...
* @return void
**/
void CwBankLinkListManager::updateHead(const uint8_t& chanNum, const uint16_t& codeWordNum, const int32_t& value)
{
...
* @return void
**/
void CwBankLinkListManager::updateTail(const uint8_t& chanNum, const uint16_t& codeWordNum, const int32_t& value)
{
...
* @return void
**/
int32_t CwBankLinkListManager::getHead(const uint8_t& chanNum, const uint16_t& codeWordNum)
{
